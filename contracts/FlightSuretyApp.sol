...
contract FlightSuretyApp is FlightSuretyData {
    ...
    address payable private contractDataAddress;
    ...
    */
    constructor(address payable dataContract) public
    {
        ...
        contractDataAddress = dataContract;
    ...
    function registerAirline(
        ...
        bool airlineIsActive = flightSuretyData.registerAirline(airlineAddress, airlineName);
        return airlineIsActive;
    }

    function submitAirlineVote(
        address airlineAddress
    ) public requireIsOperational {
        flightSuretyData.submitAirlineVote(airlineAddress);
    }
    ...
    */
    function registerFlight(
        string calldata flight, uint256 timestamp
    ) external requireIsOperational {
        flightSuretyData.registerFlight(msg.sender, flight, timestamp, STATUS_CODE_ON_TIME);
    }
    ...
    */
    function processFlightStatus(
        ...
        bytes32 flightKey = keccak256(abi.encodePacked(flight, airline));
        flightSuretyData.updateFlightStatus(statusCode, timestamp, flightKey);
    ...
    function viewFlightStatus(
        ...
        return flightSuretyData.getFlightStatus(airline, flight);
    }
